...
const perks = [
  ...
  },
  {
    name: 'For the Planet',
    Icon: Leaf,
    description: `We've plaged 1% of sales to the preservation and restoration of the natural environment.`,
  },
];
      ...
      <MaxWidthWrapper>
        <div className='py-20 mx-auto text-center flex flex-col items-center max-w-3xl'>
          ...
          <p className='mt-6 text-lg max-w-prose text-muted-foreground'>
            Welcome to DigitalStore. Every asset on our platform is verified bu
